...
function construct2DGrid(viewportMaxAxis, size, divisions) {
    gridHelper = new THREE.GridHelper(size, divisions, COLOR_CENTER_LINE, COLOR_GRID);
...
const grid = construct2DGrid(MAX_AXIS_VALUE, MAX_AXIS_VALUE * 2, MAX_AXIS_VALUE * 2);
