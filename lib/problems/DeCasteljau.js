...
document.addEventListener('keyup', keyEvent => {
    ...
    if (existingIntersectPointsComposite) {
        ...
        if (existingIntersectPointsComposite.userData.boundLine) {
            scene.remove(existingIntersectPointsComposite.userData.boundLine);
        }
...
document.addEventListener('mousedown', e => {
    ...
    if (newFound) {
        ...
        //selectedPoint.userData.parent.userData.boundLine = lineComposite;
        //newFound.userData.parent.userData.boundLine = lineComposite;
